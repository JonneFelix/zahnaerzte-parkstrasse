...
const aerztinnenBilder = [
  ...
  "/images/dr-janz.jpg",
  "/images/team/dr-anderssohn.jpg",
];

const aerztinnenNamen = [
  "Dr. Claudia Schwegmann",
  "Dr. Nina Janz",
  "Dr. Birthe Anderssohn",
];
...
export default async function Homepage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  // Ärztinnen
  const rollenKeys = ["schwegmann", "janz", "anderssohn"];
    ...
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            <div className="relative anim-einblenden-links d2">
              <div className="overflow-hidden" style={{ borderRadius: "40% 60% 45% 55% / 55% 38% 62% 45%", boxShadow: "0 20px 44px -10px rgba(105, 123, 123, 0.16)" }}>
                <Image src="/images/patientenberatung.jpg" alt={philosophie.bildAlt as string} width={600} height={500} className="w-full h-auto object-cover" style={{ aspectRatio: "6/5", filter: "saturate(0.88) brightness(1.03)", objectPosition: "center center" }} />
              </div>
      ...
      <section className="relative py-14 lg:py-32 overflow-hidden" style={{ background: "#f4f1ec" }}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10">
          ...
          {/* Drei Ärztinnen nebeneinander, zentriert — auf Mobil bricht die dritte mittig um */}
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-12 lg:gap-16 max-w-4xl mx-auto">
            {aerztinnen.map((a, i) => (
              <Link key={a.name} href={`/${locale}/team`} className={`text-center anim-einblenden d${i + 2} block ${i === 2 ? "col-span-2 md:col-span-1" : ""}`}>
                <div className="relative mb-3 md:mb-6 inline-block">
                  ...
                  <div className="team-bild-hover relative overflow-hidden w-32 h-32 md:w-44 md:h-44 lg:w-56 lg:h-56 mx-auto" style={{ borderRadius: "50% 50% 44% 56% / 54% 44% 56% 46%", boxShadow: "0 22px 44px -10px rgba(105, 123, 123, 0.16)" }}>
                    <Image src={a.bild} alt={a.name} fill className="object-cover" style={{ filter: "saturate(0.92) brightness(1.02)", objectPosition: i === 0 ? "center 28%" : i === 1 ? "center 15%" : "center 22%" }} />
