        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-10">
          ...
          <div className="grid lg:grid-cols-2 gap-10">
            ...
            <div className="overflow-hidden" style={{ borderRadius: "22px", boxShadow: "0 16px 36px -8px rgba(105,123,123,0.14)" }}>
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2372.8!2d9.8836!3d53.5524!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47b18f3d2c6d7c69%3A0x4263df27bd0ab0f5!2sParkstra%C3%9Fe%2010%2C%2022605%20Hamburg!5e0!3m2!1sde!2sde!4v1"
                width="100%"
                height="400"
                style={{ border: 0 }}
                allowFullScreen
